...
<div class="wrapper">
    ...
    <div class="container">
        <div class="col-md-offset-2 col-md-8 col-md-offset-2 text-center alert alert-info table-responsive">
            <h2 class="text-center">Quiz result history</h2>
            <table class="table table-bordered table-hover table-responsive" id="results">
                <thead>
                <tr>
                    <th class="text-center">Quiz Date and Time</th>
                    <th class="text-center">Subject</th>
                    <th class="text-center">Score<br/>
