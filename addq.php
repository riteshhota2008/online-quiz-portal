...
if (isset($_POST['newSub'])) {
    ...
    if ($result) {
        echo 'New Subject ' . $newSub . ' added successfully. Click on the close button and refresh the page to see the added subject on the list';
    ...
    <div class="container">
        <div class="col-md-offset-2 col-md-8 col-md-offset-2 alert alert-info">
            ...
            <div class="text-error">
                <h4><?php echo isset($qbErrorMsg) ? '<br />' . $qbErrorMsg . '<br /><br />' : " "; ?></h4>
            </div>
            <form class="queBankForm" role="form" method="post"
                ...
                <div class="col-md-offset-1 col-md-10 col-md-offset-1">
                    ...
                    <a href="#subModal" data-toggle="modal" rel="tooltip" title="Add a new subject"
                       data-placement="right">Subject not found?</a>
                    <br/><br/>
                    <textarea rows="5" cols="100" class="form-control" maxlength="1000" name="question"
                              placeholder="Enter your Question" required="required"
                              autofocus="autofocus"><?php if (isset($question)) {
                            echo $question;
                        } ?>
                    </textarea><br/><br/>
                    <div class="input-group">
                        ...
                        <input type="text" name="option1" class="form-control" required="required"
                               value="<?php if (isset($option1)) {
                                   echo $option1;
                               } ?>" placeholder="Enter option1; Enable the radio button for true answer"/>
                    </div>
                    <br/>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <input type="text" name="option2" class="form-control" required="required"
                               value="<?php if (isset($option2)) {
                                   echo $option2;
                               } ?>" placeholder="Enter option2; Enable the radio button for true answer"/>
                    </div>
                    <br/>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <input type="text" name="option3" class="form-control" required="required"
                               value="<?php if (isset($option3)) {
                                   echo $option3;
                               } ?>" placeholder="Enter option3; Enable the radio button for true answer"/>
                    </div>
                    <br/>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <input type="text" name="option4" class="form-control" required="required"
                               value="<?php if (isset($option4)) {
                                   echo $option4;
                               } ?>" placeholder="Enter option4; Enable the radio button for true answer"/>
                    </div>
                    <br/>
                    ...
                    <br/>
                    <p>Note: You need to add minimum 5 questions for a new subject to initiate the quiz or else it won't
                        work.</p>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="newSubForm">
                    <div class="input-group">
                        <input id="newSub" type="text" class="form-control" name="newSub"
                               placeholder="Enter a new subject" required="required"/>
                            <span class="input-group-btn"><button type="submit" class="btn btn-primary" name="newSubBtn"
                                                                  id="newSubBtn">&nbsp; Add &nbsp;</button></span>
                    </div>
                    <br/>
