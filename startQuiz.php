    ...
    <div class="container">
        <div class="col-md-offset-2 col-md-8 col-md-offset-2 alert alert-info">
            ...
            <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
                <div class="col-sm-6 text-center" style="margin-top: 10px;padding-top: 10px">
                ...
                <div class="col-sm-4 text-center" style="padding-top: 10px">
                    <button type="submit" name="startQuizBtn" role="button" class="btn btn-info btn-lg btn-block">Start
                        Quiz
                    </button>
                </div>
